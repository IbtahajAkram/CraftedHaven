    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-2xl">CraftedHaven</span>
            </Link>
            <p className="text-gray-400 mb-6 max-w-md">
              Transform your space with our premium furniture collection. Crafted with care, designed for life.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2024 CraftedHaven. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link href="/cookies" className="text-gray-400 hover:text-amber-400 text-sm transition-colors duration-300">
              Cookie Policy
            </Link>
          </div>
        </div>
